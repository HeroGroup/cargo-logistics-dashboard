@extends('layouts.admin', ['crumbs' => [
    __('Create Job') => route('jobs.create', 'simple')]
, 'title' => __('New Job')])
@section('content')
    <div>
    ...
    <div class="card col-md-12 mx-auto">
        <form method="post" action="{{route('jobs.store')}}" class="form theme-form" id="new-job-form">
            ...
            <div class="card-body">
                @csrf
                <div id="simple-job" class="default-according">
                    <div class="card">
                ...
                <div id="pickup" class="collapse" aria-labelledby="heading-pickup" data-parent="#simple-job">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                ...
                <div id="destination" class="collapse show" aria-labelledby="heading-destination" data-parent="#simple-job">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <div class="form-group row">
                ...
                <div id="instructions" class="collapse" aria-labelledby="heading-instructions" data-parent="#simple-job">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <div class="form-group row">
